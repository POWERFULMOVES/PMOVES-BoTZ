...
- [PMOVES.AI Infrastructure Documentation](./PMOVES_Infrastructure_Documentation.md) - **New:** Proxmox, Headscale, OpenMANET details.
- [PMOVES.AI Services Documentation](./PMOVES_Services_Documentation_Complete.md) - Deep dive into the 30+ microservices.
...
- **Run Build Checks:** Before pushing Dockerfile changes, run `make checks` in the `pmoves/` directory to validate against best practices (requires Docker Desktop 4.31+ or recent BuildKit).
