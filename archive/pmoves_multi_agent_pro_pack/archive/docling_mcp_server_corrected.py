...
Examples:
  ...
  python docling_mcp_server_corrected.py --transport stdio
  
  # Run with HTTP transport
  python docling_mcp_server_corrected.py --transport streamable-http --host 0.0.0.0 --port 3020
  
  # Run with custom host and port
  python docling_mcp_server_corrected.py --transport streamable-http --host localhost --port 8080
        """
    )
