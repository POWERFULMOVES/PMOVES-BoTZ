# PMOVES.AI Integration Guide for BoTZ Bot Framework

## Integration Complete

The PMOVES.AI integration template has been applied to BoTZ Bot Framework.
...
async def startup():
    await announce_service(
        slug="botz-framework",
        name="BoTZ Bot Framework",
        url=f"http://botz-framework:8050",
        port=8050,
        tier="agent"
    )
```
...
docker compose exec botz-framework env | grep PMOVES
